...
/**
 * Strict object schemas: unknown keys are rejected instead of silently
 * dropped, so extra client fields can never sneak past validation.
 */
export const postInputSchema = z
  .object({
    ...
    coverImage: httpUrlSchema.optional().or(z.literal("")),
